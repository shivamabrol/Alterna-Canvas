...
const myHTML = `<h2><strong>User Interface Design</strong></h2>
...
<table style="width: 74.94%; height: 1064px;" border="1">
    <tbody>
        ...
        <tr style="height: 89px;">
            ...
            <td style="width: 25.7176%; height: 89px;" width="132">
                <p><span style="text-decoration: line-through; color: #95a5a6;">9/5,</span> 9/7, 9/9</p>
            </td>
            <td style="width: 31.8824%; height: 89px;" width="228">
        ...
        <tr style="height: 53px;">
            ...
            <td style="width: 25.7176%; height: 53px;" width="132">
                <p><span style="text-decoration: line-through; color: #95a5a6;">10/10</span>, 10/12, 10/14</p>
            </td>
            <td style="width: 31.8824%; height: 53px;" width="228">
        ...
        <tr style="height: 89px;">
            ...
            <td style="width: 25.7176%; height: 89px;" width="132">
                <p>11/7, 11/9, <span style="text-decoration: line-through; color: #95a5a6;">11/11</span></p>
            </td>
            <td style="width: 31.8824%; height: 89px;" width="228">
        ...
        <tr style="height: 53px;">
            ...
            <td style="width: 25.7176%; height: 53px;" width="132">
                <p>11/21, 11/23, <span style="text-decoration: line-through; color: #95a5a6;">11/25</span></p>
            </td>
            <td style="width: 31.8824%; height: 53px;" width="228">
                <p>Special topics</p>
            </td>
